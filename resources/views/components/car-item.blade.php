...
<div class="car-item card">
    <a href="{{ route('car.show', $car->id) }}">
        @if($car->primaryImage)
            <img src="{{ asset('storage/' . $car->primaryImage->image_path) }}" alt="Car Image" class="car-item-image">
        @else
            <img src="{{ asset('images/default-car.png') }}" alt="Default Car Image" class="car-item-image">
        @endif
        </a>
    </a>
    <div class="p-medium">
