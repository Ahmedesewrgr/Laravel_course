                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>Model</label>
                                    <select>
                                        <option value="bmw">Corolla</option>
                                        <option value="lexus">Highlander</option>
                                        <option value="mercedes">Prius</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select>
                                        ...
                                        <option value="bmw">California</option>
                                        <option value="lexus">Texas</option>
                                        <option value="mercedes">Florida</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select>
                                        ...
                                        <option value="bmw">Houston</option>
                                        <option value="lexus">San Diego</option>
                                        <option value="mercedes">Los Angeles</option>
                                    </select>
                                </div>
                            </div>
                        </div>
